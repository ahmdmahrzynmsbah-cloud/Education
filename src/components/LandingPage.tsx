        ...
        <div className="container mx-auto px-4 sm:px-6 grid lg:grid-cols-2 gap-8 lg:gap-12 items-center relative z-10">
          ...
          >
             ...
             <div className="relative w-full aspect-square bg-gradient-to-br from-[#00B4D8]/5 to-transparent rounded-[3rem] border border-gray-100 dark:border-white/5 p-8 shadow-2xl flex items-center justify-center overflow-hidden">
                ...
                {/* Floating Badge */}
                <div className="absolute top-12 right-4 sm:-right-2 bg-white dark:bg-[#1A1A24] p-4 rounded-2xl flex items-center gap-3 shadow-xl border border-gray-100 dark:border-[#2D2D3D] z-10">
                  <div className="w-10 h-10 bg-[#00B4D8]/10 dark:bg-[#D4AF37]/10 rounded-xl flex items-center justify-center text-[#00B4D8] dark:text-[#D4AF37]">
                    <Trophy className="w-5 h-5" />
                  </div>
                  <div className="text-right">
                    <p className="text-[10px] font-bold text-gray-400 dark:text-gray-500">المركز الأول</p>
